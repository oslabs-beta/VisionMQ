...
function Metrics() {
  ...
  return (
    <div id='metrics'>
        <ul>
            <li>Make a ServiceNode type that has handles on the bottom<br></br>So that I left could be in and the right out</li>
            <li>DONESet up label on edges</li>
            <li>Figure out how to change color of edges dynamically</li>
            <li>Figure out how to make the minimap smaller</li>
            <li>DONEMake a Queue type node</li>
